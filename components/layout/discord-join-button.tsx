...
export function DiscordJoinButton({ href, className }: DiscordJoinButtonProps) {
  return (
    <a
      ...
      className={cn(
        'group relative inline-flex h-9 items-center justify-center overflow-hidden whitespace-nowrap rounded-[var(--btn-radius,0.9rem)] border border-white/15 bg-white/[0.08] px-4 text-sm font-semibold text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.2)] backdrop-blur-xl backdrop-saturate-150 transition-[transform,background-color,border-color] duration-200 hover:scale-105 hover:border-white/25 hover:bg-white/[0.14]',
        className,
      )}
    >
